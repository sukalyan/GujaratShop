         ...
         <div id="container" style="font-size: 10px;">
            ...
            <div id="rcontainer" align="middle"> 
				...
				<div style="width:400px; height:auto; float:left; margin-left:160px;">
				    <form name="f" action="update_cat.php" method="post" enctype="multipart/form-data">
				    <table class="table">
					<tr>
					    <td>Category Name</td>
					    <td>
						<input type="text" name="name" id="name" value="<?php echo $res['cat_name'];?>" class="text" required/>
