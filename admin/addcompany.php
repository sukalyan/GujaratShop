         ...
         <div id="container" style="font-size: 10px;">
            ...
            <div id="rcontainer" align="middle"> 
				...
				?>
					...
					<?php
					$fet=mysql_query("select * from `company`");
					while($res=mysql_fetch_array($fet)){
					?>
					<tr>
					    <td class="td"><?php echo $res['comp_name'];?></td>
					    <td class="td"><a href="edit_company.php?id=<?php echo $res['id'];?>"><img src="image/edit.png" width="60"></a></td>
