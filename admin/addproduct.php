	   ...
	   <div id="con">
         <div id="container" style="font-size: 10px;">
            ...
            <div id="rcontainer" align="middle"> 
				...
				?>
				    <form name="f" action="addraw.php" method="post" enctype="multipart/form-data" onSubmit="return valid();">
				    <table class="table">
					<!--<tr>
					<td>Barcode</td>
					...
					<td>category</td>
					<td>
						<select name="category" class="text wdt">
						<?php
					...
					<td>company</td>
					<td>
						<select name="company" class="text wdt">
						<?php
					...
					<td>Unit</td>
					<td>
					<select name="unit" class="text wdt">
					...
					<tr>
					<td>MRP</td>
					<td><input type="text" name="mrp" class="text"></td>
					</tr>
					 <td>&nbsp;</td>
