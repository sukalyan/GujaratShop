...
include_once('function.php');
	...
	$priceretailer=htmlentities($_POST['priceretailer'],ENT_QUOTES);
	$pricedistributer=htmlentities($_POST['pricedistributer'],ENT_QUOTES);
...
/*echo "insert into `readystock` set `bar`='$barcode', `category`='$category' ,`company`='$company' ,`product`='$product',`mrp`='$mrp',`costprice`='$price',`distributer`='$pricedistributer' ,`retailer`='$priceretailer',`unit`='$unit'";*/
	...
	mysql_query("insert into `readystock` set `bar`='$barcode', `category`='$category' ,`company`='$company' ,`product`='$pid',`product_name`='$product',`mrp`='$mrp',`costprice`='$price',`distributer`='$pricedistributer' ,`retailer`='$priceretailer',`unit`='$unit'");
